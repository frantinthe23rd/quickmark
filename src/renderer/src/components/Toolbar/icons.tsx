...
const Icon = (p: SVGProps<SVGSVGElement>): React.JSX.Element => (
  <svg
    width="18" height="18"
    viewBox="0 0 24 24"
    fill="none"
...
export const IconOrdered = (): React.JSX.Element => (
  <Icon>
    <path d="M10 6h11M10 12h11M10 18h11" />
...
export const IconSource = (): React.JSX.Element => (
  <Icon>
    <path d="M9 7l-5 5 5 5" />
    <path d="M15 7l5 5-5 5" />
  </Icon>
)
export const IconWysiwyg = (): React.JSX.Element => (
  <Icon>
    <rect x="3" y="4" width="18" height="16" rx="2" />
