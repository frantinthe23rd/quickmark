; installer.nsh is compiled twice: once for the installer, once for the
; uninstaller. Guard installer-only content with !ifndef BUILD_UNINSTALLER.

!ifndef BUILD_UNINSTALLER
  ; File association checkbox on the Finish page (after Directory selection).
